    ...
    */
    public function compile($args, $compiler)
    {
        ...
        if ($compiler->smarty->merge_compiled_includes || isset($_attr['inline'])) {
            ...
            if (!$compiler->has_variable_string && (substr_count($include_file, '"') == 2 or substr_count($include_file, "'") == 2) and substr_count($include_file, '(') == 0) {
                ...
                if ($this->compiler->template->template_resource != $tmp) {
                    $tpl = $compiler->smarty->createTemplate ($tmp, $compiler->template->cache->data_id, $compiler->template->compile_id, $compiler->template);
        ...
        */
        ...
        $_output = "<?php \$_template = new {$compiler->smarty->template_class}($include_file, \$_smarty_tpl->smarty, \$_smarty_tpl, \$_smarty_tpl->cache->data_id, \$_smarty_tpl->compile_id, $_caching, $_cache_lifetime);\n"; 
