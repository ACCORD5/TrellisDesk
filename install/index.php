...
class td_install {
    ...
    private function step_3($params=array())
    {
        ...
        $this->output .= "<div id='ticketroll'>
                        ...
                        ". $this->trellis->skin->group_table_row( 'Time Zone', "<select name='admin_time_zone' id='admin_time_zone'>". $this->trellis->func->drop_downs->time_zone_drop( $this->trellis->cache->data['install']['admin']['time_zone'], 0) ."</select>", 'a' ) ."". $this->trellis->skin->group_table_row( 'Daylight Savings', $this->trellis->skin->custom_radio( 'admin_time_dst', array( 0 => 'Inactive', 1 => 'Active', 2 => 'Auto' ), $this->trellis->cache->data['install']['admin']['time_dst'] ), 'a' ) ."
