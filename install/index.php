...
class td_install {
    ...
    private function step_3($params=array())
    {
        ...
        $this->output .= "<div id='ticketroll'>
                        ...
                        ". $this->trellis->skin->group_table_row( 'Time Zone', "<select name='admin_time_zone' id='admin_time_zone'>". $this->trellis->func->drop_downs->time_zone_drop( $this->trellis->cache->data['install']['admin']['time_zone'] ) ."</select>", 'a' ) ."
