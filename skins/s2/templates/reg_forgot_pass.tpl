...
<div class='content_block'>
    <form action='{$td_url}/index.php?page=register&amp;code=doforgot' method='post' onsubmit='return validate_form(this)'>
    {$token_forgot_pass}
    ...
    <tr>
        <td colspan='2'><input type='submit' class='submit' name='submit' id='forgot' value='{$lang['reset_pass_button']}' /></td>
    </tr>
    </table>
    </form>
</div>