...
<div class='content_block'>
    <form action='{$td_url}/index.php?page=register&amp;code=new' method='post' onsubmit='return validate_form(this)'>
    {$token_register}
    ...
    {/if}
    <tr>
        <td colspan='2'><input type='submit' class='submit' name='submit' id='create' value='{$lang['create_account_button']}' /></td>
    </tr>
    </table>
    </form>
</div>