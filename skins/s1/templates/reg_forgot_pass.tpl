<div class="content_block">
    ...
    {/if}
    <form action="{$td_url}/index.php?page=register&amp;act=doforgotpass" method="post">
    ...
    <div class="formtail"><input type="submit" name="submit" id="forgot" value="{$lang['reset_pass_button']}" class="button" /></div>
    </form>
</div>